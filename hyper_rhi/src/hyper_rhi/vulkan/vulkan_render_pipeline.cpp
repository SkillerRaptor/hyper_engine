...
{
    std::shared_ptr<RenderPipeline> VulkanGraphicsDevice::create_render_pipeline_platform(const RenderPipelineDescriptor &descriptor)
    {
        ...
        return std::make_shared<VulkanRenderPipeline>(descriptor, *this, pipeline);
    }
