...
namespace HyperEditor
{
	...
	{
	private:
		static HyperCore::Ref<HyperRendering::RenderContext> s_RenderContext;
	...
	public:
		...
		static rttr::variant DrawSelectableImage(const std::string& title, HyperRendering::TextureHandle texture);
		...
		static void SetRenderContext(HyperCore::Ref<HyperRendering::RenderContext>& renderContext);
	};
}
