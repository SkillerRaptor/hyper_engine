...
namespace HyperEditor
{
	...
	{
		m_FolderTexture = m_TextureManager->Create("./cache/textures/icons/folder-solid.png");
		m_FileTexture = m_TextureManager->Create("./cache/textures/icons/file-solid.png");
		m_ShaderTexture = m_TextureManager->Create("./cache/textures/icons/code-solid.png");
		m_ImageTexture = m_TextureManager->Create("./cache/textures/icons/image-solid.png");
		m_ModelTexture = m_TextureManager->Create("./cache/textures/icons/cubes-solid.png");
	...
	void AssetsPanel::OnRender()
	{
		...
		if (ImGui::BeginTable("##AssetsTable", columns, ImGuiTableFlags_SizingFixedSame))
		{
			...
			for (auto& [filePath, fileData] : AssetsManager::GetFiles())
			{
				...
				ImGui::ImageButton(m_TextureManager->GetImageId(textureHandle), { m_ItemSize, m_ItemSize }, { 0, 1 }, { 1, 0 }, 0, buttonBackground);
