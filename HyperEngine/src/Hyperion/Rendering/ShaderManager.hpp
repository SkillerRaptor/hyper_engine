...
namespace Hyperion
{
	...
	public:
		...
		virtual void SetMatrix2(uint32_t handle, const std::string& name, const Matrix2<float>& matrix) = 0;
		virtual void SetMatrix3(uint32_t handle, const std::string& name, const Matrix3<float>& matrix) = 0;
		virtual void SetMatrix4(uint32_t handle, const std::string& name, const Matrix4<float>& matrix) = 0;
