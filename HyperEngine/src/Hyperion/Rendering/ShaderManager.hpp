...
namespace Hyperion
{
	...
	public:
		...
		virtual void SetVector2(uint32_t handle, const std::string& name, const Vector2& vector) = 0;

		virtual void SetVector3(uint32_t handle, const std::string& name, float x, float y, float z) = 0;
		virtual void SetVector3(uint32_t handle, const std::string& name, const Vector3& vector) = 0;

		virtual void SetVector4(uint32_t handle, const std::string& name, float x, float y, float z, float w) = 0;
		virtual void SetVector4(uint32_t handle, const std::string& name, const Vector4& vector) = 0;
