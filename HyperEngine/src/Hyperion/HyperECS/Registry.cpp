...
namespace Hyperion
{
	...
	void Registry::Each(const typename std::common_type<std::function<void(Entity)>>::type function)
	{
	...
	EntityTraits::EntityType Registry::GetEntityId(const Entity entity) noexcept
	{
		return EntityTraits::EntityType{ entity & EntityTraits::EntityMask };
	}

	EntityTraits::VersionType Registry::GetEntityVersion(const Entity entity) noexcept
	{
