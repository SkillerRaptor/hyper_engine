...
namespace Hyperion
{
	OpenGLVertexArray::OpenGLVertexArray(VertexLayout vertexLayout)
	...
	unsigned int OpenGLVertexArray::GetRendererId() const
	{
		return m_RendererId;
	}

	VertexLayout OpenGLVertexArray::GetVertexLayout() const
	{
