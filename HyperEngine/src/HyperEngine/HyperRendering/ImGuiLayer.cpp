...
namespace HyperRendering
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		GLFWwindow* window = HyperCore::Application::Get()->GetWindow()->GetContext()->GetWindow();
	...
	void ImGuiLayer::OnUpdate(HyperUtilities::Timestep timeStep)
	{
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		HyperCore::Application* app = HyperCore::Application::Get();
