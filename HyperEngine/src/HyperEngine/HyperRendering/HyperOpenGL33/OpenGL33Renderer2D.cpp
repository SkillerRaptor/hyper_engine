...
namespace HyperRendering
{
	...
	{
		m_QuadVertexArray = HyperCore::CreateRef<OpenGL33VertexArray>(VertexLayout::Vertex2D);
		m_QuadVertexArray->Bind();

		m_QuadVertexBuffer = HyperCore::CreateRef<OpenGL33VertexBuffer>(VertexLayout::Vertex2D, MaxVertices);
		...
		m_QuadIndexBuffer = HyperCore::CreateRef<OpenGL33IndexBuffer>(quadIndices, MaxIndices);
	...
	void OpenGL33Renderer2D::SetCamera(const glm::vec3& position, const glm::vec3& rotation, float fov, const glm::vec2& clippingPlanes, const glm::vec2& viewportRect, HyperECS::CameraComponent::ProjectionType projectionType)
	{
