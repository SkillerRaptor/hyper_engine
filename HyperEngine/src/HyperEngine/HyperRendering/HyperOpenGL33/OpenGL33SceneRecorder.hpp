...
namespace HyperRendering
{
	...
	{
	private:
		HyperCore::Scope<OpenGL33FrameBuffer> m_GameFrameBuffer;
		HyperCore::Scope<OpenGL33FrameBuffer> m_EditorFrameBuffer;

	public:
		OpenGL33SceneRecorder(HyperCore::Ref<TextureManager> textureManager, GLFWwindow* window);
