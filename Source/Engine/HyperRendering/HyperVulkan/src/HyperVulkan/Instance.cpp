...
namespace HyperRendering::Vulkan
{
	...
	auto Instance::initialize() -> HyperCore::Result<void, HyperCore::Errors::ConstructError>
	{
	...
	auto Instance::instance() const -> VkInstance
	{
		return m_instance;
	}
	
	auto Instance::debug_messenger() const -> VkDebugUtilsMessengerEXT
	{
		return m_debug_messenger;
	}

	auto Instance::create_instance() -> HyperCore::Result<void, HyperCore::Errors::ConstructError>
	{
		VkApplicationInfo application_info{};
		application_info.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
		application_info.pApplicationName = m_context.window().title().c_str();
	...
	auto Instance::create_debug_messenger() -> HyperCore::Result<void, HyperCore::Errors::ConstructError>
	{
		VkDebugUtilsMessengerCreateInfoEXT debug_messenger_create_info{};
		debug_messenger_create_info.sType = VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT;
		debug_messenger_create_info.messageSeverity =
	...
	auto Instance::get_required_extensions() const -> std::vector<const char*>
	{
	...
	auto Instance::are_validation_layers_supported() const -> bool
	{
	...
	VKAPI_ATTR auto VKAPI_CALL Instance::debug_callback(
