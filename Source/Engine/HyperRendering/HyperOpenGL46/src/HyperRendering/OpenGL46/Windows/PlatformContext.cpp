...
namespace HyperRendering::OpenGL46::Windows
{
	...
	bool CPlatformContext::initialize(HyperPlatform::IWindow* window)
	{
		...
		if (pixel_format == 0)
		{
			HyperCore::CLogger::error("OpenGL 4.6: failed to choose pixel format!");
			return false;
		}
		...
		{
			HyperCore::CLogger::error("OpenGL 4.6: wglCreateContextAttribsARB not found!");
			return false;
		}
		...
		{
			HyperCore::CLogger::error("OpenGL 4.6: failed to create context!");
			return false;
		}
