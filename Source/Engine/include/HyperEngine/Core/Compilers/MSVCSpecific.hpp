...
#if !defined(_MSC_VER)
#	error This file should only be included on MSVC compilers.
#endif
...
#define HYPERENGINE_FORCE_INLINE __forceinline
#define HYPERENGINE_NO_INLINE __declspec(noinline)
