...
namespace HyperCore
{
	...
	public:
		...
		{
			HYPERENGINE_ASSERT_WITH_MESSAGE(m_size > 1, "CSparsePool: The size must be greater than 1!");
		...
		{
			HYPERENGINE_ASSERT_WITH_MESSAGE(position < m_size, "CSparsePool: Index out of range!");
