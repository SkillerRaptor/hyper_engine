...
TEST_CASE("'clamp' of three numbers can be calculated with constexpr", "[HyperMath][clamp]")
{
	STATIC_REQUIRE(HyperMath::clamp(1, 1, 0) == 0);
	STATIC_REQUIRE(HyperMath::clamp(2, 2, 1) == 1);
	STATIC_REQUIRE(HyperMath::clamp(3, 3, 2) == 2);
	
	STATIC_REQUIRE(HyperMath::clamp(4, -4, 1) == 1);
	STATIC_REQUIRE(HyperMath::clamp(5, -5, 2) == 2);
	STATIC_REQUIRE(HyperMath::clamp(6, -6, 3) == 3);
	
	STATIC_REQUIRE(HyperMath::clamp(1.0F, 1.0F, 0.0F) == 0.0F);
	STATIC_REQUIRE(HyperMath::clamp(1.0F, 2.0F, 1.0F) == 1.0F);
	STATIC_REQUIRE(HyperMath::clamp(1.0F, 3.0F, 2.0F) == 2.0F);
	
	STATIC_REQUIRE(HyperMath::clamp(1.0F, -4.0F, 1.0F) == 1.0F);
	STATIC_REQUIRE(HyperMath::clamp(1.0F, -5.0F, 2.0F) == 1.0F);
	STATIC_REQUIRE(HyperMath::clamp(1.0F, -6.0F, 3.0F) == 1.0F);
}

TEST_CASE("'saturate' of one number can be calculated with constexpr", "[HyperMath][saturate]")
{
	STATIC_REQUIRE(HyperMath::saturate(1) == 1);
	STATIC_REQUIRE(HyperMath::saturate(2) == 1);
	STATIC_REQUIRE(HyperMath::saturate(3) == 1);
	
	STATIC_REQUIRE(HyperMath::saturate(-4) == 0);
	STATIC_REQUIRE(HyperMath::saturate(-5) == 0);
	STATIC_REQUIRE(HyperMath::saturate(-6) == 0);
	
	STATIC_REQUIRE(HyperMath::saturate(1.0F) == 1.0F);
	STATIC_REQUIRE(HyperMath::saturate(2.0F) == 1.0F);
	STATIC_REQUIRE(HyperMath::saturate(3.0F) == 1.0F);
	
	STATIC_REQUIRE(HyperMath::saturate(-4.0F) == 0.0F);
	STATIC_REQUIRE(HyperMath::saturate(-5.0F) == 0.0F);
	STATIC_REQUIRE(HyperMath::saturate(-6.0F) == 0.0F);
	
	STATIC_REQUIRE(HyperMath::saturate(1.1F) == 1.0F);
	STATIC_REQUIRE(HyperMath::saturate(2.2F) == 1.0F);
	STATIC_REQUIRE(HyperMath::saturate(3.3F) == 1.0F);
	
	STATIC_REQUIRE(HyperMath::saturate(-4.4F) == 0.0F);
	STATIC_REQUIRE(HyperMath::saturate(-5.5F) == 0.0F);
	STATIC_REQUIRE(HyperMath::saturate(-6.6F) == 0.0F);
}
