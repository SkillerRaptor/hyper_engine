...
namespace hyper_engine
{
    ...
    VulkanGraphicsDevice::VulkanGraphicsDevice(const Logger &logger, const GraphicsDeviceDescriptor &descriptor)
        : m_logger(logger)
        ...
        , m_debug_marker(descriptor.debug_marker)
    {
        ...
        if (m_debug_validation)
        {
            ...
            {
                HE_WARN(m_logger, "Failed to enable requested Validation Layers");
            }
        }
        ...
        HE_INFO(m_logger, "Created Vulkan Graphics Device");
    }
    ...
    {
        return std::make_shared<VulkanSurface>(m_logger, *this, window);
    }

    std::shared_ptr<CommandList> VulkanGraphicsDevice::create_command_list()
    {
        return std::make_shared<VulkanCommandList>(m_logger, *this);
    }
    ...
    void VulkanGraphicsDevice::choose_physical_device()
    {
        ...
        HE_INFO(m_logger, "Physical Device Info:");
        HE_INFO(m_logger, "  Name: {}", properties.deviceName);
        HE_INFO(
            m_logger,
            "  API Version: {}.{}.{}",
        ...
        HE_INFO(m_logger, "  Type: {}", device_type);
    }
        ...
        void *)
    {
        ...
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT:
            HE_TRACE(m_logger, "Validation Layer: {}", callback_data->pMessage);
            break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT:
            HE_INFO(m_logger, "Validation Layer: {}", callback_data->pMessage);
            break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT:
            HE_WARN(m_logger, "Validation Layer: {}", callback_data->pMessage);
            break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT:
            HE_ERROR(m_logger, "Validation Layer: {}", callback_data->pMessage);
            break;
        default:
            break;
        }
